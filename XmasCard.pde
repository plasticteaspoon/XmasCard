...
{ //<>//
    ...
    script.add(new Speak (santa,   15.5 * FRAMES_PER_SECOND,  1.25 * FRAMES_PER_SECOND, "Down the chimney I go."));
    ...
    script.add(new MoveTo(santa,   22.5 * FRAMES_PER_SECOND,  0.5  * FRAMES_PER_SECOND,  675, 345, 300)); //lands on the roof
    script.add(new MoveTo(santa,   24.5 * FRAMES_PER_SECOND,  4    * FRAMES_PER_SECOND,  425, 345, 300)); //walks along roof
    script.add(new MoveTo(santa,   28.5 * FRAMES_PER_SECOND,  0.5  * FRAMES_PER_SECOND,  425, 400, 300)); //jumps onto garage
    script.add(new MoveTo(santa,   30   * FRAMES_PER_SECOND,  1.5  * FRAMES_PER_SECOND,  340, 400, 300)); //walks to the sleigh
    script.add(new Speak(santa,    31.5 * FRAMES_PER_SECOND,  2    * FRAMES_PER_SECOND, "Merry Christmas to all..."));
    script.add(new MoveTo(santa,   33.5 * FRAMES_PER_SECOND,  1.5  * FRAMES_PER_SECOND,  250, 400, 300)); //walks to the sleigh
    script.add(new Speak(santa,    35   * FRAMES_PER_SECOND,  2    * FRAMES_PER_SECOND, "...and to all a goodnight"));    
